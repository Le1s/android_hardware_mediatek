...
$(warning building mt6630_ant_m1)
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_ant_m1.cfg
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := cfg_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_ant_m2)    
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_ant_m2.cfg
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := cfg_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_ant_m3)       
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_ant_m3.cfg
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := cfg_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_ant_m4)        
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_ant_m4.cfg
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := cfg_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_patch_e1_hdr) 
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_patch_e1_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_patch_e2_hdr) 
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_patch_e2_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_patch_e3_0_hdr) 
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_patch_e3_0_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
...
$(warning building mt6630_patch_e3_1_hdr) 
    include $(CLEAR_VARS)
    LOCAL_MODULE := mt6630_patch_e3_1_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
...
$(warning building ROMv1_patch_1_hdr) 
    include $(CLEAR_VARS)
    LOCAL_MODULE := ROMv1_patch_1_0_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
    ...
    include $(CLEAR_VARS)
    LOCAL_MODULE := ROMv1_patch_1_1_hdr.bin
    LOCAL_MODULE_TAGS := optional
    LOCAL_MODULE_CLASS := ETC
    LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/firmware
    LOCAL_SRC_FILES := patch_folder/$(LOCAL_MODULE)
...
$(warning building ROMv2_lm_patch_1_hdr) 
    include $(CLEAR_VARS)
