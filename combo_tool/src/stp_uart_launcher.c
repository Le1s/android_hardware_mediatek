...
int cmd_hdr_sch_patch (P_STP_PARAMS_CONFIG pStpParamsConfig)
{
    ...
    if (gWmtFd > 0)
    {
			...
			(!strcmp(chipName,"mt6735")))
        {
			...
			}else if(!strcmp(chipName,"mt6752") || !strcmp(chipName,"mt6735")){
...
int main(int argc, char *argv[])
{
	...
	if((0x6735 == chipId) || (0x6752 == chipId) || (0x6582 == chipId) || (0x6592 == chipId) || (0x6572 == chipId) || (0x6571 == chipId) || (0x8127 == chipId))
	{
